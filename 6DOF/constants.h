...
//
const double Ix = (1.5); // Moment of inertia about the X-axis [lbs*ft^2]
const double Iy = 200.756; // Moment of inertia about the Y-axis [lbs*ft^2]
const double Iz = 200.756; // Moment of inertia about the Z-axis [lbs*ft^2]
